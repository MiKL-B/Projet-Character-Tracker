...
export class SignUp extends Component {
  static displayName = SignUp.name;
    ...
    handleSubmit(event) {
        alert('Le nom a été soumis : ' + this.state.value_name + ' ' + this.state.value_email + ' ' + this.state.value_pw + ' ' + this.state.value_confirme_pw);
                  ...
                  <div className="col-md-9 col-lg-8 mx-auto">
                    ...
                    <form id="form-login" onSubmit={this.handleSubmit}>
                      <div className="form-floating mb-3">
                        <input type="email" value_name={this.state.value} onChange={this.handleChange_name} className="form-control" id="name" placeholder="name@example.com"/>
                        <label htmlFor="floatingInput">Name</label>
                      </div>
                      <div className="form-floating mb-3">
                        <input type="email" value_email={this.state.value} onChange={this.handleChange_email} className="form-control" id="email" placeholder="name@example.com"/>
                      ...
                      <div className="form-floating mb-3">
                        <input type="password" value_confirme_pw={this.state.value} onChange={this.handleChange_confirme_pw} className="form-control" id="confirme-password" placeholder="Password" minLength="8"/>
