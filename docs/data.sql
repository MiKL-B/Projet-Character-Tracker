...
INSERT INTO Account(username,password,is_admin,mail) 
VALUES  ('michel','pass',true,'michel@gmail.com'),
...
INSERT INTO Schema(is_public,name_schema,desc_schema,readable_date)
VALUES  (false,'GOT','schema de games of thrones la serie tv',false),
		(false,'STARWARS','schema de la guerre des etoiles',false);
...
INSERT INTO family_personage(id_personage,id_family)
VALUES  (5,1),
		(1,2);

INSERT INTO groupuser(desc_group,private)
VALUES ('le groupe du projet charactertracker', true);

INSERT INTO group_account(id_account,id_group_user)
VALUES 	(1,1),
		(2,1),
		(3,1);

INSERT INTO Permission(level_permission)
VALUES (1);

INSERT INTO group_permission_schema(id_permission,id_schema,id_group_user)
VALUES (1,2,1);

INSERT INTO Event(date_event,order_event,desc_event,place_event,name_event)
VALUES ('1980',1,'premiere relation','teletravail','relation surtout tele');
